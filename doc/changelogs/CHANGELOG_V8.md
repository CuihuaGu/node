...
* [[`76ba1b59bc`](https://github.com/nodejs/node/commit/76ba1b59bc)] - **(SEMVER-MAJOR)** **async_hooks**: C++ Embedder API overhaul (Andreas Madsen) [#14040](https://github.com/nodejs/node/pull/14040)
...
* [[`539f4c0e16`](https://github.com/nodejs/node/commit/539f4c0e16)] - **(SEMVER-MAJOR)** **process**: use internal/errors in internalNextTick (Tobias Nießen) [#13982](https://github.com/nodejs/node/pull/13982)
